...
function listAllFiles(fs, dir) {
    return __awaiter(this, void 0, void 0, function* () {
        console.log(`dir: ${dir}`);
        let files = [];
        let entries = yield vscode.workspace.fs.readDirectory(dir);
        for (const e of entries) {
            ...
            if (e[1] == vscode.FileType.Directory) {
                console.log(`${e[0]}`);
                files = files.concat(yield listAllFiles(fs, vscode.Uri.joinPath(dir, e[0])));
            }
        }
        return files;
    });
